...
func _build_world() -> void:
	...
	add_child(hud)
	hud.configure("Fase 3 - Minhoca das Escolhas", "Setas ou WASD movimentam | mova o mouse pra andar tambem | Encoste ou clique na fruta correta | 1, 2 e 3 selecionam")
