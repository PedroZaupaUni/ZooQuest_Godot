...
func _show_instructions() -> void:
	...
	var body := UI.make_label(
		...
		"Passaro: use cima/baixo ou mova o mouse para escolher uma passagem antes de chegar ao obstaculo.\n\n" +
		"Minhoca: use as setas/WASD ou mova o mouse e encoste na fruta-resposta correta.\n\n" +
