...
func _draw() -> void:
    ...
    for x in [90, 1170]:
        draw_rect(Rect2(x - 16, 380, 32, 180), Color(0.38, 0.22, 0.10))
        draw_circle(Vector2(x, 350), 86, Color(0.14, 0.48, 0.24))
        draw_circle(Vector2(x - 45, 390), 62, Color(0.18, 0.56, 0.29))
        draw_circle(Vector2(x + 48, 390), 62, Color(0.18, 0.56, 0.29))
...
func _build_interface() -> void:
    ...
    var tagline := UI.make_label("Matematica, logica e boas escolhas em uma aventura pelo zoologico", 22, Color(0.10, 0.28, 0.22))
    ...
    var footer := UI.make_label("Jogo educativo 2D | Godot | ODS 4 - Educacao de Qualidade", 17, Color(1, 1, 1, 0.94))
